            ...
            {expandedItems[initialItem.id] && (
              <div style={{ padding: 16 }}>
                ...
                <div style={{ marginBottom: 16 }}>
                  ...
                  {/* 選択肢一覧 */}
                  {(initialItem.selections || []).map((selection, selIndex) => (
                    <div
                      key={selection.id}
                      style={{
                        background: '#fff',
                    ...
                    >
                      ...
                      >
                        ...
                        <select
                          ...
                          onChange={(e) => updateSelection(initialItem.id, selection.id, 'type', e.target.value)}
                          onClick={(e) => e.stopPropagation()}
                          style={{
                            marginLeft: 8,
                            padding: '4px 6px',
                        ...
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            deleteSelection(initialItem.id, selection.id);
                          }}
                          style={{
                            background: '#984545',
                            color: '#fff',
                          ...
                          {selection.type === 'input' && (
                            <div style={{ marginBottom: 12, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                              <input
                                ...
                                onChange={(e) => updateSelection(initialItem.id, selection.id, 'placeholder', e.target.value)}
                                style={{ padding: '4px 6px', border: '1px solid #ccc', borderRadius: 3, fontSize: 13 }}
                              />
                              <input
                                placeholder="ボタン文字"
                                value={selection.buttonText || ''}
                                onChange={(e) => updateSelection(initialItem.id, selection.id, 'buttonText', e.target.value)}
                                style={{ padding: '4px 6px', border: '1px solid #ccc', borderRadius: 3, fontSize: 13 }}
                              />
                              <label style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                                <input
                                  ...
                                  onChange={(e) => updateSelection(initialItem.id, selection.id, 'required', e.target.checked)}
                                />
                              ...
                              <input
                                ...
                                onChange={(e) => updateSelection(initialItem.id, selection.id, 'maxLength', parseInt(e.target.value))}
                                style={{ padding: '4px 6px', border: '1px solid #ccc', borderRadius: 3, fontSize: 13 }}
                              />
                            </div>
                          )}
                                ...
                                <div key={optIndex} style={{ display: 'flex', gap: 8, marginTop: 6 }}>
                                  <input
                                    ...
                                    onChange={(e) => {
                                      ...
                                      updateSelection(initialItem.id, selection.id, 'options', newOptions);
                                    }}
                                    style={{ flex: 1, padding: '4px 6px', border: '1px solid #ccc', borderRadius: 3, fontSize: 13 }}
                                  />
                                  <button
                                    onClick={() => {
                                      const newOptions = (selection.options || []).filter((_, i) => i !== optIndex);
                                      updateSelection(initialItem.id, selection.id, 'options', newOptions);
                                    }}
                          ...
                          {selection.type === 'link' && (
                            <div style={{ marginBottom: 12, display: 'grid', gridTemplateColumns: '100px 1fr 1fr', gap: 8 }}>
                              <select
                                ...
                                onChange={(e) => updateSelection(initialItem.id, selection.id, 'linkType', e.target.value)}
                                style={{ padding: '4px 6px', border: '1px solid #ccc', borderRadius: 3, fontSize: 13 }}
                              >
                              ...
                              <input
                                ...
                                onChange={(e) => updateSelection(initialItem.id, selection.id, 'linkValue', e.target.value)}
                                style={{ padding: '4px 6px', border: '1px solid #ccc', borderRadius: 3, fontSize: 13 }}
                              />
                              {selection.linkType === 'email' && (
                                <input
                                  ...
                                  onChange={(e) => updateSelection(initialItem.id, selection.id, 'emailSubject', e.target.value)}
                                  style={{ padding: '4px 6px', border: '1px solid #ccc', borderRadius: 3, fontSize: 13 }}
                                />
                              )}
                            </div>
                          ...
                          {selection.type !== 'next' && (
                            <div>
                              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                                ...
                                <button
                                  onClick={() => addResponsePattern(initialItem.id, selection.id)}
                                  style={{
                                    background: '#41807A',
                                    color: '#fff',
                                    border: 'none',
                              ...
                              {selection.responsePatterns.map((pattern, patIndex) => (
                                <div key={pattern.id} style={{ marginBottom: 6 }}>
                                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: 6 }}>
                                    <textarea
                                      value={pattern.text}
                                      onChange={(e) => updateResponsePattern(initialItem.id, selection.id, pattern.id, e.target.value)}
                                    ...
                                    />
                                    <button
                                      onClick={() => deleteResponsePattern(initialItem.id, selection.id, pattern.id)}
                                      style={{
                                        background: '#984545',
                                        color: '#fff',
                                        border: 'none',
